...
//   const navigate = useNavigate(); // ✅ FIXED: useNavigate from react-router-dom
...
//       navigate('/login'); // ✅ This will now redirect correctly
//     } catch (err) {
//       setErrors(err);
//       setIsSubmitting(false);
//     }
...
//         {errors.msg && (
//           <div className="bg-red-100 text-red-700 px-4 py-2 mb-4 rounded">{errors.msg}</div>
//         )}
