...
// const Profile = () => {
//   const { user: loggedInUser, getUserProfile, updateUserProfile, isLoading } = useContext(AuthContext);
...
//   useEffect(() => {
//     if (!isLoading && !loggedInUser && profile && profile.user._id === loggedInUser?._id) {
...
//       console.log('Sending to updateUserProfile:', { bio: editBio, jobTitle: editJobTitle, skills: skillsArray });
//       const updated = await updateUserProfile({ bio: editBio, jobTitle: editJobTitle, skills: skillsArray });
//       console.log('Received from updateUserProfile:', updated);
//       setProfile((prev) => ({
//         ...prev,
//         user: {
//           ...prev.user,
...
//   if (!profile) return <div className="text-center text-gray-600 py-8">Loading...</div>;
...
//           ) : (
//             <>
//               <p className="mt-2 text-gray-700">{user.bio || 'No bio provided yet.'}</p>
...
//                 <span className="text-blue-600 font-semibold">{post.user.name}</span>
...
//                     className="bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-1 rounded-lg text-sm font-semibold hover:from-red-600 hover:to-red-700 transition-all"
//                   >
//                     Delete
//                   </button>
//                 )}
